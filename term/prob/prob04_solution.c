...
int main() {
        ...
        /**
        ** The idea is to add one or more counters for each loop which
        ** are lexicographically strictly decreasing at each loop
        ** iteration and then check if their value is bounded from
        ** below.
        **/
